...
exports.newUserBadge = function (email, claimCode, req, callback) {
  ...
  var url = "https://umaine.mainestateoflearning.org/claim/"+claimCode;
  mailer.sendMail({
    from: 'Maine State of Learning <info@mainestateoflearning.org>',
    to: email,
...
exports.awardBadge = function (email, name, claimCode, req, callback) {
 ...
 //var url = req.siteUrl + "login";
  var url = "https://umaine.mainestateoflearning.org/login";
  mailer.sendMail({
    from: 'Maine State of Learning <info@mainestateoflearning.org>',
    to: email,
    subject: "You've earned the "+badgeName+" badge. Add it to your My Badges page!",
...
exports.resetPw = function (email, uniqueId, req, callback) {
 // var url = req.siteUrl + "reset-pw/"+uniqueId;
  var url = "https://umaine.mainestateoflearning.org/reset-pw/"+uniqueId;
  mailer.sendMail({
    from: 'Maine State of Learning <info@mainestateoflearning.org>',
    to: email,
...
exports.contactUs = function (req, callback) { 
  ...
  mailer.sendMail({
    from: 'Maine State of Learning <info@mainestateoflearning.org>',
    to: 'info@mainestateoflearning.org',
